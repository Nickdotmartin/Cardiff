...
# images_dir = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\checkStim_Feb2nd\checkStim_feb2nd_v1_images"
# videos_dir = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\checkStim_Feb2nd\checkStim_feb2nd_v1_videos"
# session_name = 'Feb2nd_v1'
images_dir = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\checkStim_Feb2nd\checkStim_feb2nd_v2_images"
videos_dir = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\checkStim_Feb2nd\checkStim_feb2nd_v2_videos"
session_name = 'Feb2nd_v2'
...
pr1_down: fix0-sep, =I2-5
pr1_right: fix1+sep-2  (note this is different here for radial compared to tangent), =J2+5-2
Note, I'm now setting p2 in relation to fixation, not p1.
pr2_down: fix0+sep  (note this is different here for radial compared to tangent) =I2+5
pr2_right: fix1-sep (note this is different here for radial compared to tangent) =J2-5

FOR CONT
pr1_down: fix0-sep, =I2+5
pr1_right: fix1+sep-2  (note this is different here for radial compared to tangent), =J2-5
Note, I'm now setting p2 in relation to fixation, not p1.
pr2_down: fix0+sep  (note this is different here for radial compared to tangent) =I2-5
pr2_right: fix1-sep (note this is different here for radial compared to tangent) =J2+5-2
...
# fixation = 326, 866  # top-left corner of cropped image
...
#
#             # set to process 50 frames (or 140 for isi24)
#             from_fr = pr1_frame-8
#             to_fr = from_fr+50
#             if isi == 24:
#                 to_fr = from_fr+140
...
#
# results_path = os.path.join(images_dir, f'monitor_refresh_results_{session_name}.csv')
...
x_tick_locs = np.arange(0, 50, 8)
x_tick_labels = np.arange(x_tick_label_start, 13 + x_tick_label_start, 2)
