...
q_bins_list = [True, False]
n_bins_list = [25, 10, 9, 7, 6, 5]
...
#
#         print(f'\nn_bins: {n_bins}, q_bins: {q_bins}')
#
#         bins_folder = f'{bin_type}{n_bins}'
#
#         # loop through runs
...
#
#             bins_path = os.path.join(root_path, run_dir, bins_folder)
#
...
#                     # # # # #
#                     fit_curve_plot, psignifit_dict = results_to_psignifit(csv_path=stair_df, save_path=bins_path,
...
#
#             # save zeros df - run and q_bins in name.
#             print(f'thr_array:\n{thr_array}')
#
...
#             thr_filename = f'{bin_type}{n_bins}_{run_dir}.csv'
