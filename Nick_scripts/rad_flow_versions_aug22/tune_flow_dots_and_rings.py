...
# increase dots depth and scale their size with depth
deep_with_sizes = True

print(f"\nflow_dots, deep_with_sizes: {deep_with_sizes}")
...
# Give dots a pale green colour, which is adj_dots_col different to the background
dots_colour = [this_bgColour[0] - adj_dots_col, this_bgColour[1], this_bgColour[2] - adj_dots_col]
flow_dots = visual.ElementArrayStim(win, elementTex=None, elementMask='circle',  # orig used 'gauss'
                                    ...
                                    colorSpace=this_colourSpace, colors=dots_colour)
...
flow_ring_colour = [this_bgColour[0] + adj_dots_col, this_bgColour[1], this_bgColour[2] + adj_dots_col]
ring_colours = [this_bgColour, flow_ring_colour] * int(n_rings / 2)
