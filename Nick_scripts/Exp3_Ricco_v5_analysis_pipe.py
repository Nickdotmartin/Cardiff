...
for p_idx, participant_name in enumerate(participant_list):
    ...
    for run_idx, run_dir in enumerate(run_folder_names):
        ...
        #
        # n_pix_list = thr_df['n_pix'].unique()
        # len_pix_list = thr_df['len_pix'].unique()
        # len_deg_list = thr_df['diag_deg'].unique()
        ...
        #              x_ticks_vals=list(range(len(len_pixels_list))), x_tick_names=len_pixels_list,
        #              x_axis_label='Number of pixels',
        #              y_axis_label='Probe Luminance',
        #              fig_title='Ricco_v5: n_pix vs thresholds',
        ...
        #                     fig_title='Ricco_v5: log(n_pix) v log(∆I)',
        ...
        #              y_axis_label='Probe Luminance',
        #              fig_title='Ricco_v5: length vs thresholds',
        ...
        #                     y_axis_label='Contrast: log(∆I)',
        #                     fig_title='Ricco_v5: log(length) v log(∆I)',
        ...
        #                     y_axis_label='Contrast: log(∆I)',
        #                     fig_title='Ricco_v5: log(degrees) v log(∆I)',
    ...
    d_average_participant(root_path=root_path, run_dir_names_list=run_folder_names,
                          ...
                          # groupby_col=['n_pix', 'len_pix', 'diag_deg'],
                          groupby_col=['len_pix'],
                          # cols_to_drop=['stair_names', 'stack', 'cond'],
                          cols_to_drop=['stair_names', 'stack', 'cond'],
                          cols_to_replace=['separation', 'n_pix', 'diag_deg'],
                          )
