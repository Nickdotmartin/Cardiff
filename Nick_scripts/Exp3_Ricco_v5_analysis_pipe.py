    ...
    for run_idx, run_dir in enumerate(run_folder_names):
        ...
        run_data_df = pd.read_csv(run_data_path,
                                  usecols=['trial_number', 'stair', 'stair_name',
                                           ...
                                           'ISI', 'corner', 'newLum',
                                           'trial_response', '4. fps', 'len_pix', 'diag_deg', ])
        ...
        # len_pixels_list = sorted(run_data_df['len_pix'].unique())
        # print(f'len_pixels_list: {len_pixels_list}')
        #
        # # todo: add degrees to plots
        # len_deg_list = sorted(run_data_df['diag_deg'].unique())
