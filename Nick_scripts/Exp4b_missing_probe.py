...
expInfo = {'1. Participant': 'nicktest',
           ...
           '6_probe_coherence': ['rotation', 'radial', 'translation', 'incoherent']}
...
# coherence_list = list(np.repeat(probe_coherence[:3], n_stairs))
...
maxColor1 = 1
minColor1 = -1
bgLumP = 20  # Background lum in percent of maxLum'  # 20
...
breaks = visual.TextStim(win=win, name='breaks',
                         ...
                         text="Break\nTurn on the light and take at least 30-seconds break.\n"
                              "Remember, if you are unsure how to respond, just guess!\n"
...
for step in range(n_trials_per_stair):
    ...
    for thisStair in stairs:
        ...
        print(f"probe_coherence: {probe_coherence}, ISI: {ISI}, sep: {sep}")
