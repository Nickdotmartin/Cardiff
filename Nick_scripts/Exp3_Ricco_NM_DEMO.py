...
'''
Script to demonstrate Ricco - with separation of 0 and 6 pixels.
...
expName = 'Exp3_Ricco_NM_DEMO'  # from the Builder filename that created this script

expInfo = {'1_Participant': 'Ricco_test',
