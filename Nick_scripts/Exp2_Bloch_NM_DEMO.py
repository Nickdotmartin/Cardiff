...
'''
Script to demonstrate Bloch - with ISI of 0 and 6 frames.
'''
...
expName = 'Exp2_Bloch_NM_DEMO'  # from the Builder filename that created this script

expInfo = {'1_Participant': 'Bloch_test',
...
# ISI_ms_list = [-2, 0, 8.3333334, 16.6666667, 25, 37.5, 50, 100]
ISI_ms_list = [0, 25]
...
filename = f'{_thisDir}{os.sep}' \
           ...
           f'{participant_name}_1{os.sep}' \
           f'{participant_name}_1_output'
