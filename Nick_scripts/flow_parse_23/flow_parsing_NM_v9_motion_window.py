...
expInfo = {'1_participant_name': 'Nicktest',
           ...
           # '7_motion_duration': [1000, 0, 35, 70, 105, 140, 175, 210, 240, 280, 320, 360, 400, 440, 480, 520, 560,
           #                         600],
           '8_debug': [True, False, True]
           }
...
# selected_bg_motion_ms = int(expInfo['7_motion_duration'])  # motion before and after stim, which is in the middle
