...
expInfo = {'1_participant_name': 'Nicktest_05102023',
           '2_run_number': 1,
...
for step in range(n_trials_per_stair):
    ...
    for thisStair in stairs:
        ...
        while repeat:
            ...
            probeSpeed = thisStair.next()  # in pixels per frame
            if debug:
            ...
            # CHECK RESPONSES
            # not using correct/incorrect, just in or out.
            # The staircase algorithm will aim for a response score of .5.
