...
exp_path = r"C:\Users\sapnm4\OneDrive - Cardiff University\PycharmProjects\Cardiff\Exp3_Ricco_v6"
...
for p_idx, participant_name in enumerate(participant_list):
    ...
    for run_idx, run_dir in enumerate(run_folder_names):
        ...
        run_thr_plot_w_markers(thr_df, x_col='diag_deg', y_col='thr', hue_col='cond',
                               ...
                               fig_title=f'P{p_idx+1} run{run_idx+analyse_from_run}. Ricco_v{ricco_version}: length vs thresholds',
        ...
        log_log_w_markers_plot(thr_df, x_col='diag_deg', y_col='delta_I', hue_col='cond',
                               ...
                               fig_title=f'P{p_idx+1} run{run_idx+analyse_from_run}. Ricco_v{ricco_version}: log(degrees) v log(∆I)',
    ...
    fig_title = f'P{p_idx} average thresholds - Ricco_v{ricco_version} (n={len(run_folder_names)})'
    ...
    fig_title = f'P{p_idx} average log(degrees), log(∆I) thresholds - Ricco_v{ricco_version} (n={len(run_folder_names)})'
...
participant_list = ['Kristian', 'Simon', 'Tony']  #, 'Kim', 'Kris', 'Simon']
trim_n = 2
print(f'exp_path: {exp_path}')
