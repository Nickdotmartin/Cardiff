import os
from MATLAB_analysis import a_data_extraction, b1_extract_last_values, \
    b2_last_reversal, b3_plot_staircase, c_plots, d_averageParticipant
...
for run_idx, run_dir in enumerate(run_folder_names):
    ...
    print(f'\nrunning analysis for {participant_name}, {run_dir}\n')
