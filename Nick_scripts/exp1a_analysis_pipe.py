...
# use 1 for Martin, 2 for Tony, 3 for 'Simon', 'Maria', 'Kristian', 'Kim'
p_idx_plus = 3

for p_idx, participant_name in enumerate(participant_list):
    root_path = f'/Users/nickmartin/Documents/PycharmProjects/Cardiff/exp1a_data/{participant_name}'
    ...
    d_average_participant(root_path=root_path, run_dir_names_list=run_folder_names,
                          show_plots=False, trim_n=None, error_bars='SE')
