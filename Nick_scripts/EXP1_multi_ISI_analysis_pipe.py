...
# exp_path = os.path.join(root_path, "EXP1_R_G")
# exp_path = os.path.join(root_path, "EXP1_R_G_rot")
# exp_path = os.path.join(root_path, "EXP1_sep4_5")
# exp_path = os.path.join(root_path, "EXP1_split_probes")
# exp_path = os.path.join(root_path, "jitter_rgb")
# exp_path = os.path.join(root_path, "eyetracking")
exp_path = os.path.join(project_path, "Exp4b_missing_probe\incoherent")  # radial, rotation, translation
...
e_average_exp_data(exp_path=exp_path, p_names_list=participant_list,
                   ...
                   error_type='SE', n_trimmed=[4, 2], verbose=True)
