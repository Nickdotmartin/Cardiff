...
expName = 'Exp2_Bloch_NM_v3'  # from the Builder filename that created this script
...
# todo: should ISI_ms_list just include values from 2 to 9?
...
# todo: get rid of 2probe stim?
# cond_types = ['1probe', '2probe']
cond_types = ['1probe']
...
# ful stimulus duration, not just isi
...
# PROBEs
# probe sizes choice
if probe_size == '6pixels':  # 6 pixels
    probeVert = [(0, 0), (1, 0), (1, 1), (2, 1),
                 (2, -2), (-1, -2), (-1, -1), (0, -1)]
elif probe_size == '3pixels':  # 3 pixels
...
for stair_idx in expInfo['stair_list']:
    ...
    if separations[stair_idx] + congruence_list[stair_idx] == -1:
        stair_name = -.1
    """
    # stair_name = isi_vals_list[stair_idx]
    stair_name = stair_names_list[stair_idx]
    if background == 'flow_rad':
        # stair_name = isi_vals_list[stair_idx] * flow_dir_list[stair_idx]
