...
# todo: add motion before or durng probes option
# todo: add vary fix option but make sure it is longer that prelim motion
...
prelim_bg_flow_ms = expInfo['10_prelim_bg_flow_ms']
