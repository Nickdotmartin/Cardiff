...
- later, remove 'interleaved' dir from file structure
...
expInfo = {'01. Participant': 'scriptTest_25092023',
           ...
           '05. ISI_dur_in_ms': [25, 16.67, 100, 50, 41.67, 37.5, 33.34, 25, 16.67, 8.33, 0, -1],
...
orientation = expInfo['06. Probe_orientation']
record_fr_durs = eval(expInfo['07. Record_frame_durs'])
background = expInfo['08. Background']
# prelim_bg_flow_ms = int(expInfo['09. prelim_bg_flow_ms'])
monitor_name = expInfo['10. monitor_name']
mask_type = expInfo['11. mask_type']
...
#  second contrast is whether background motion starts 70 or 350ms prior to probe 1.
prelim_vals = [70, 350]
...
for step in range(n_trials_per_stair):
    ...
    for thisStair in stairs:
        ...
        thisExp.addData('prelim_ms', prelim_bg_flow_ms)
        thisExp.addData('actual_prelim_ms', actual_prelim_bg_flow_ms)
