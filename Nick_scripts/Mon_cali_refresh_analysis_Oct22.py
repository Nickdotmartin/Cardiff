...
videos_dir = r"C:\Users\sapnm4\Videos\mon_cali_vids_Oct22"
videos_dir = os.path.normpath(videos_dir)

images_dir = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\mon_cali_images_Oct22"
...
It starts woth lists of sep and isi vals, its a bit convoluted, but it reflects the order of priority for analysis.
...
pr1_down: fix0-sep
pr1_right: fix1-sep
pr2_down: pr1_down+sep+5  (5 is half bounding box size)
pr2_right: pr_right+sep+5-2 (minus two here seems to align boxes)
...
# fixation = 485, 561  # top-left corner of cropped image
# print(f'fixation: ({fixation[0]}, {fixation[1]})')
#
# if sep >= 99:
#     p1_tl = fixation[0], fixation[1]
# else:
#     p1_tl = fixation[0]-sep, fixation[1]-sep
#
# cond_dir = rf"ISI_{isi}_sep_{sep}_v{ver}\all_full_frames"
# image_name = f"ISI_{isi}_sep_{sep}_v{ver}_fr{show_frame}.jpg"
#
...
# image2_name = f"ISI_{isi}_sep_{sep}_v{ver}_fr{p2_show_frame}.jpg"
...
# else:
#     p2_adjustment = int(ROI_size/2) + sep
# p2_tl = p1_tl[0]+p2_adjustment, p1_tl[1]+p2_adjustment-2
#
#
...
# excel_path = r"C:\Users\sapnm4\OneDrive - Cardiff University\Pictures\mon_cali_images_Oct22\frame_and_bbox_details.xlsx"
...
#         print(f'\n{filename}, ISI_{isi}, sep_{sep}, ver: {ver}')
#
...
#             cond_dir = rf"ISI_{isi}_sep_{sep}_v{ver}\all_full_frames"
#             image_name = f"ISI_{isi}_sep_{sep}_v{ver}_fr{frame}.jpg"
#             image_path = os.path.join(images_dir, cond_dir, image_name)
#
...
#             save_row = [filename, isi, sep, ver, idx, frame,
...
#                           columns=['filename', 'isi', 'sep', 'version', 'idx', 'frame',
