...
=IF(A2=-1, E2, IF(A2=0, E2+8, IF(A2=2, E2+16, IF(A2=4, E2+24, IF(A2=6, E2+32, IF(A2=9, E2+44, IF(A2=12, E2+56, IF(A2=24, E2+104, 0))))))))
...
I manually add the co-ordinates to the excel document in columns called pr1_down, pr1_right, pr2_down, pr2_right.
...
fixation = 504, 579  # corner of cropped image
...
# '''
#
# probe2_dict = {-1: 0, 0: 8, 2: 16, 4: 24, 6: 32, 9: 44, 12: 56, 24: 140}
#
# cond_ver_list = list(results_df['filename'].unique())
# print(f'cond_ver_list (n={len(cond_ver_list)}):\n{cond_ver_list}')
