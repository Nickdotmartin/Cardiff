...
#                    win.saveFrameIntervals(f"/home/martinbossard/Documents/EXPERIMENTS_INTEGRATION/EXPERIMENTS_SCRIPTS_NEW/DEMOS/EXP1_DEMO/frameIntervals_DEMO/run5/FrameIntervals_{trial_number}_ISI{ISI}")
...
#fig_name = f"{participant_name}{os.sep}{participant_name}_{run_number}{os.sep}{participant_name}_{run_number}_frames.png"
