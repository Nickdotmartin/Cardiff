...
'''
Based on Exp1_Jan23 and Exp1_split_probes.
...
expInfo = {'1. Participant': 'split_probes_test',
           '2. Run_number': '1',
...
probe_dots_vert = [(0, -1), (0, -2), (-1, -2), (-1, -1),
                   (2, -1), (2, 0), (1, 0), (1, -1)]
probe_1a_L = visual.ShapeStim(win, vertices=probe_L_vert, fillColor='red', colorSpace=this_colourSpace,
                              lineWidth=0, opacity=1, size=probe_size, interpolate=False)
probe_2a_dots = visual.ShapeStim(win, vertices=probe_dots_vert, fillColor='green', colorSpace=this_colourSpace,
                                 lineWidth=0, opacity=1, size=probe_size, interpolate=False)

probe_2b_L = visual.ShapeStim(win, vertices=probe_L_vert, fillColor='green', colorSpace=this_colourSpace,
                              lineWidth=0, opacity=1, size=probe_size, interpolate=False)
probe_1b_dots = visual.ShapeStim(win, vertices=probe_dots_vert, fillColor='red', colorSpace=this_colourSpace,
                                 lineWidth=0, opacity=1, size=probe_size, interpolate=False)
...
for step in range(n_trials_per_stair):
    ...
    for thisStair in stairs:
        ...
        while repeat:
            ...
            probe_1a_L.setFillColor([this_probeColor, this_probeColor, this_probeColor])
            probe_2a_dots.setFillColor([this_probeColor, this_probeColor, this_probeColor])
            probe_2b_L.setFillColor([this_probeColor, this_probeColor, this_probeColor])
            probe_1b_dots.setFillColor([this_probeColor, this_probeColor, this_probeColor])
