...
expInfo = {'1. Participant': 'nick_test',
           ...
           '5. ISI_dur_in_ms': [25, 16.67, 100, 50, 41.67, 37.5, 33.34, 25, 16.67, 8.33, 0],
           ...
           '11. prelim_bg_flow_ms': [70, 350],
           '12. monitor_name': ['OLED', 'asus_cal', 'Nick_work_laptop', 'Samsung', 'Asus_VG24', 'HP_24uh', 'NickMac', 'Iiyama_2_18'],
           }
...
bgColor_rgb1 = bgLumProp#bgLum / maxLum
...
nDots = 10000
taille = 10000  # french for 'size', 'cut', 'trim', 'clip' etc
...
#                                            this_bgColour[2]-adj_dots_col])
                                    colors=[this_bgColour[0],
                                            this_bgColour[1]+adj_dots_col/2,
                                            this_bgColour[2]])
...
raisedCosTexture2 = visual.filters.makeMask(1440, shape='raisedCosine', fringeWidth=0.6, radius=[1.0, 1.0])
...
blankslab = np.ones((1440, 20))  # create blank slabs to put to left and right of image
