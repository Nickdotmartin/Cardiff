...
#
#     # try and open exp1_master_thr_path, if it doesn't exist, try different path
#     if os.path.isfile(exp1_master_thr_path):
#         exp1_master_thr_df = pd.read_csv(exp1_master_thr_path)
#     else:
#         exp1_master_thr_path = os.path.join(exp1_path, 'MASTER_psignifit_thresholds.csv')
#         exp1_master_thr_df = pd.read_csv(exp1_master_thr_path)
#
#
...
#     if os.path.isfile(sep45_master_thr_path):
#         sep45_master_thr_df = pd.read_csv(sep45_master_thr_path)
#     else:
#         sep45_master_thr_path = os.path.join(sep45_path, 'MASTER_psignifit_thresholds.csv')
#         sep45_master_thr_df = pd.read_csv(sep45_master_thr_path)
